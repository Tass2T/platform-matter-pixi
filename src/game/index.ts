...
export default class Game {
  ...
  constructor() {
    ...
    this.#pixiApp
      ...
      .then(() => {
        ...
        if (!config.PHYSIC_DEBUG_MODE) document.body.appendChild(this.#pixiApp.canvas as HTMLCanvasElement)
        this.initGame()
      })
  }
  ...
  async initGame() {
    ...
    this.gameStates = {
      ...
      gameOver: new GameOverScreen(this.#pixiApp.stage, this.#scoreBoard, this.changeState),
    }
  ...
  update(delta: number) {
    this.gameStates[this.currentGameState].update(delta, this.#inputManager.getPressedInputs())
  }
}
